...
アイヌ語のカタカナ表記に禁則がどのように適用されるべきか不明。

`lang="ja"`だと、`line-break: strict;`のとき、行頭の小書きのカナが禁じられる。「ㇷ゚」が行頭に来ないように制御される。これは必要な制御か？`lang="ja"`を外すと、例えば`lang="ain"`としてしまうと、この制御が効かない。
...
日本語の中にアイヌ語を挿入する場合は`<span class="ain">アシㇼパ</span>`とするなどの工夫が必要。

逆に、アイヌ語の中の「インターナショナルスクール」といった日本語の長い単語はアイヌ語と区別がつかない。アイヌ語の中に日本語の長い単語を挿入した場合は、`<span class="ja">インターナショナルスクール</span>`とするなどの工夫が必要。
